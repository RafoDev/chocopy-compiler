// https://github.com/Childcity/ASTree
    ...
    */
    ...
    private:
        ...
        explicit ASTNode(NodeType type, std::string text) noexcept
            : type_(std::move(type)), text_(std::move(text)), parent_(SharedPtr())
        {
    ...
    public:
        ...
        void addChild(const SharedPtr child)
        {
            ...
            {
                for (const auto &grandChild : child->getChilds())
                    addChild(grandChild);
            }
            else
            {
        ...
        // void addChildren(std::list<SharedPtr> children)
        // {
        //     for (auto child : children)
        //         addChild(child);
        // }
        // void addChild(const SharedPtr &otherNode)
        // {
        //     // Verificar si otherNode no es nulo
        //     if (otherNode)
        //     {
        //         // Obtener los hijos del otro nodo
        //         const auto &children = otherNode->getChilds();

        //         // Agregar los hijos al nodo actual
